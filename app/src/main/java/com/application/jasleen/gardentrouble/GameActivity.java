...
/**
 * GameActivity which supports the Game UI and makes grid of buttons
 * Supports initiating animation scans and sound
 * Uses game logic to display correct information about cell on screen
 */
...
public class GameActivity extends AppCompatActivity {
    ...
    private MediaPlayer foundRabbitSound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateUI();
        startGame = new Game();
        startGame.generateGrid(NUM_COLS, NUM_ROWS, NUM_RABBITS);
            ...
            for (int col = 0; col < NUM_COLS; col++) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(!startGame.checkIfScanned(finalCol, finalRow)) {
    ...
    private void scanningSound(){
        if(scanningCellsSound!=null) {
            scanningCellsSound.release();
        }
    ...
    private void foundRabbitSound(){
        if(foundRabbitSound!=null) { foundRabbitSound.release(); }
